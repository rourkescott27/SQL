...
FROM 'D:\SQL\chapter_4\us_counties_2010.csv'
...
-- 4.7
COPY us_counties_2010
TO 'D:\SQL\chapter_4\us_counties_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');

-- 4.8
COPY us_counties_2010(geo_name, internal_point_lat, internal_point_lon)
TO 'D:\SQL\chapter_4\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'D:\SQL\chapter_4\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
